var CONFIG = {"version":"0.2.5","hostname":"https://jolyneanasui.github.io","root":"/","statics":"/","favicon":{"normal":"images/favicon.ico","hidden":"images/failure.ico"},"darkmode":false,"auto_scroll":false,"js":{"chart":"frappe-charts%401.5.0.min.iife.min.js","copy_tex":"copy-tex%400.12.0.min.js","fancybox":"jquery%26fancybox%26justifiedGallery.min.js"},"css":{"katex":"katex/katex%400.12.0.min.css","mermaid":"mermaid.css","fancybox":"fancybox%26justifiedGallery.min.css"},"loader":{"start":true,"switch":false},"search":null,"quicklink":{"timeout":3000,"priority":true}};const getRndInteger = function (min, max) {
...
const scrollHandle = function (event) {
  ...
  if (diffY < 0) {
    ...
    sideBar.firstElementChild.style.top = "";
  } else if (diffY > 0) {
    // Scroll up
    siteNav.removeClass('down')
    siteNav.toggleClass('up', SHOW);
    if (SHOW && sideBarAffix) {
      sideBar.firstElementChild.style.top = siteNavHeight + "px";
    }else if (SHOW) {
      var delta = Math.max(0, window.pageYOffset + siteNavHeight + 10 - headerHight - parseFloat(window.getComputedStyle(sideBar.firstElementChild.firstElementChild, null)['paddingTop']));
      sideBar.firstElementChild.style.top = delta + "px";
    }else sideBar.firstElementChild.style.top = "";
  } else {
    // First scroll event
  }
  //scrollAction.x = Container.scrollLeft;
